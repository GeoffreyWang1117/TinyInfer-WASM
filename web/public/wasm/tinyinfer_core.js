 ...
 * @returns {boolean}
 */
export function check_simd_support() {
    const ret = wasm.check_simd_support();
    return ret !== 0;
}
...
export function createTensor(data, dims) {
    ...
    const ptr1 = passArray32ToWasm0(dims, wasm.__wbindgen_export2);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.createTensor(ptr0, len0, ptr1, len1);
...
export class Benchmark {
    ...
    getResults() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.benchmark_getResults(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
     ...
     */
    clearResults() {
        wasm.benchmark_clearResults(this.__wbg_ptr);
    }
    /**
    ...
    benchmarkReLU(size, iterations) {
        const ret = wasm.benchmark_benchmarkReLU(this.__wbg_ptr, size, iterations);
        return ret;
    }
    /**
     * Benchmark Conv2D
     ...
     * @returns {number}
     */
    benchmarkConv2D(batch, channels, size, iterations) {
        const ret = wasm.benchmark_benchmarkConv2D(this.__wbg_ptr, batch, channels, size, iterations);
        return ret;
    }
    /**
    ...
    benchmarkMatMul(size, iterations) {
        const ret = wasm.benchmark_benchmarkMatMul(this.__wbg_ptr, size, iterations);
        return ret;
    }
    /**
...
export class Model {
     ...
     */
    isInitialized() {
        const ret = wasm.model_isInitialized(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    getInfo() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.model_getInfo(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
export class Tensor {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Tensor.prototype);
        obj.__wbg_ptr = ptr;
        TensorFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    toString() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.tensor_toString(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    getData() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.tensor_getData(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
     ...
     */
    getSize() {
        const ret = wasm.tensor_getSize(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * Get shape as array
    ...
    getShape() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.tensor_getShape(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
if (Symbol.dispose) Tensor.prototype[Symbol.dispose] = Tensor.prototype.free;

const TinyInferFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_tinyinfer_free(ptr >>> 0, 1));
/**
...
export class TinyInfer {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        TinyInferFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_tinyinfer_free(ptr, 0);
    }
    /**
    ...
    getModelInfo() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.tinyinfer_getModelInfo(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
     ...
     */
    loadTestModel() {
        wasm.tinyinfer_loadTestModel(this.__wbg_ptr);
    }
    /**
     * Create a new TinyInfer instance
     */
    constructor() {
        const ret = wasm.tinyinfer_new();
        this.__wbg_ptr = ret >>> 0;
        TinyInferFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     * @param {Uint32Array} input_shape
     * @returns {Float32Array}
     */
    infer(input_data, input_shape) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArrayF32ToWasm0(input_data, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passArray32ToWasm0(input_shape, wasm.__wbindgen_export2);
            const len1 = WASM_VECTOR_LEN;
            wasm.tinyinfer_infer(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
if (Symbol.dispose) TinyInfer.prototype[Symbol.dispose] = TinyInfer.prototype.free;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('tinyinfer_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
